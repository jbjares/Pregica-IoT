    ...
    function loadEditor() {
        RED.menu.init({id:"btn-sidemenu",
            options: [
                ...
                {id:"menu-item-help",
                    label: RED.settings.theme("menu.menu-item-help.label","Pregica-IoT - Website"),
                    href: RED.settings.theme("menu.menu-item-help.url","#")
                },
                {id:"menu-item-node-red-version", label:"Powered by Node-RED v"+RED.settings.version, onselect: showAbout }
            ]
        });
